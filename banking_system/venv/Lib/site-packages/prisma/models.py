...
class User(bases.BaseUser):
    ...
    aadharNo: Optional[_str] = None
    age: Optional[_int] = None
    gender: Optional[_str] = None
    address: Optional[_str] = None
    city: Optional[_str] = None
    landmark: Optional[_str] = None
    pincode: Optional[_str] = None
    state: Optional[_str] = None
    clientSign: Optional[_str] = None
    nomineeName: Optional[_str] = None
    nomineePhone: Optional[_str] = None
    nomineeAddress: Optional[_str] = None
    nomineeEmail: Optional[_str] = None
    nomineeSign: Optional[_str] = None
...
class Transaction(bases.BaseTransaction):
    ...
    processedBy: Optional[_str] = None
