...
class AccountActions(Generic[_PrismaModelT]):
    ...
    async def create(
        ...
        account = await Account.prisma().create(
            data={
                ...
                'accountNumber': 'bbejhfidcb',
                'accountType': 'bgeecijdgg',
                'userId': 'bdiicjafbj',
            },
        )
        ```
        ...
        *,
        ...
        total = await Account.prisma().create_many(
            data=[
                {
                    # data to create a Account record
                    'accountNumber': 'bgehebiafc',
                    'accountType': 'bghffegacj',
                    'userId': 'bhghchehcc',
                },
                {
                    # data to create a Account record
                    'accountNumber': 'dcgchcbbf',
                    'accountType': 'bdedcabahc',
                    'userId': 'ghfhiafcb',
                },
            ],
            skip_duplicates=True,
    ...
    async def find_first(
        ...
        -------
        ```py
        # find the second Account record ordered by the accountNumber field
    ...
    async def find_first_or_raise(
        ...
        -------
        ```py
        # find the second Account record ordered by the accountType field
    ...
    async def group_by(
        ...
        *,
        ...
        -------
        ```py
        # group Account records by accountNumber values
        # and count how many records are in each group
...
class TransactionActions(Generic[_PrismaModelT]):
    ...
    async def create(
        ...
        transaction = await Transaction.prisma().create(
            data={
                ...
                'amount': 1868141281.186084,
                'transactionType': 'beeifcbebf',
                'accountId': 'bgcigfahea',
            },
        )
        ```
        """
        ...
        *,
        ...
        total = await Transaction.prisma().create_many(
            data=[
                {
                    # data to create a Transaction record
                    'amount': 1249606685.83590,
                    'transactionType': 'hgdhbjhhj',
                    'accountId': 'ecjjjfbae',
                },
                {
                    # data to create a Transaction record
                    'amount': 1775811865.89314,
                    'transactionType': 'jjfeafhfj',
    ...
    async def find_many(
        ...
        # find the first 5 Transaction records ordered by the id field
    ...
    async def find_first_or_raise(
        ...
        -------
        ```py
        # find the second Transaction record ordered by the transactionType field
    ...
    async def group_by(
        ...
        *,
        ...
        -------
        ```py
        # group Transaction records by amount values
        # and count how many records are in each group
