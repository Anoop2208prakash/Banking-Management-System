        ...
        *,
        ...
        total = await Account.prisma().create_many(
            data=[
                {
                    # data to create a Account record
                    'accountNumber': 'bdiicjafbj',
                    'userId': 'bgehebiafc',
                },
                {
                    # data to create a Account record
                    'accountNumber': 'bghffegacj',
                    'userId': 'bhghchehcc',
                },
            ],
            skip_duplicates=True,
...
class TransactionActions(Generic[_PrismaModelT]):
            ...
            data=[
                {
                    ...
                    'transactionType': enums.TransactionType.DEPOSIT,
                    'accountId': 'beeifcbebf',
                },
                {
                    # data to create a Transaction record
                    'amount': 1628650740.124960,
                    'transactionType': enums.TransactionType.DEPOSIT,
                    'accountId': 'idfjadbcc',
                },
            ],
    ...
    async def group_by(
        ...
        *,
        ...
        -------
        ```py
        # group Transaction records by processedBy values
        # and count how many records are in each group
